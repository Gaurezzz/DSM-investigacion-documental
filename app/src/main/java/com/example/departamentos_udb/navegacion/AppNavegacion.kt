package com.example.departamentos_udb.navegacion
...
import com.example.departamentos_udb.ui.navegacion.Rutas
...
fun AppNavegacion(
    ...
    NavHost(
        ...
        // Pantalla de visualización para estudiantes
        ...
        // Detalle para estudiantes (solo visualización)
        composable(
        ...
        // Detalle para administradores (con opciones de edición y eliminación)
        composable(
